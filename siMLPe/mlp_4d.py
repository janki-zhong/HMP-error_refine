...
class LN(nn.Module):
    def __init__(self, dim, epsilon=1e-5):
        ...
        self.alpha = nn.Parameter(torch.ones([1, 1, dim, 1]), requires_grad=True)
        self.beta = nn.Parameter(torch.zeros([1, 1, dim, 1]), requires_grad=True)
...
class Spatial_FC(nn.Module):
    def __init__(self, dim):
        ...
        self.arr0 = Rearrange('b c n d -> b c d n')
        self.arr1 = Rearrange('b c d n -> b c n d')
